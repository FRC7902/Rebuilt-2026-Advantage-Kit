  ...
  private void configureBindings() {
    ...
    driverController
        ...
        .onTrue(
            Commands.sequence(
                Commands.parallel(
                    linearIntake.setHeight(Meters.of(0.01)).withTimeout(5.0),
                    indexer.set(0.5).withTimeout(5.0)),
                linearIntake.setHeight(Meters.of(0.35)).withTimeout(1.0).andThen(indexer.set(0))));
    ...
    driverController
        ...
        .whileTrue(
            Commands.parallel(
                ...
                hood.setAngle(Degrees.of(25.0))
                    .until(() -> hood.getAngle().isNear(hood.getAngleSetpoint(), Degrees.of(1.0)))
                    .andThen(indexer.set(0.5))));

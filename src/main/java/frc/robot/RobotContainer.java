...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    Command intakingFuel =
        Commands.sequence(
            Commands.parallel(
                linearIntake.setHeightAndStop(Meters.of(0.0)),
                indexer.set(1.0),
    ...
    Command shootFuel =
        Commands.parallel(
            ...
            hood.setAngleAndStop(Degrees.of(25)).andThen(indexer.set(0.1)));
    Command stopShootFuel =
        Commands.parallel(
            shooter.setVelocity(RPM.of(0)), hood.setAngleAndStop(Degrees.of(0)), indexer.set(0.0));
    driverController.button(2).whileTrue(shootFuel).onFalse(stopShootFuel);
